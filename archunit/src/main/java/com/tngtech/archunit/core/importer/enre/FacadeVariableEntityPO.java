...
public class FacadeVariableEntityPO extends AbstractFacadeEntityPO {
    ...
    public FacadeVariableEntityPO() {
    }

    public FacadeVariableEntityPO(Integer id, Integer isIntrusive, Integer isDecoupling, String name, Integer notAOSP, Integer oldAOSP, String ownership, String qualifiedName, Integer entityMapping, Integer commitsCount, String category, Integer calledTimes, String file, String packageName, String classBodyModify, Boolean global, String rawType, EnreLocationPO location, String modifiers) {
