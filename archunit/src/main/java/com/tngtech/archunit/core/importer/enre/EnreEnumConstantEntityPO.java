...
public class EnreEnumConstantEntityPO extends EnreInternalEntityPO {

    private String file;
    private EnreLocationPO location;

    public EnreEnumConstantEntityPO(Integer entityId, String entityName, String qualifiedName, String category, String ownership, Integer parentId, String file, EnreLocationPO location) {
