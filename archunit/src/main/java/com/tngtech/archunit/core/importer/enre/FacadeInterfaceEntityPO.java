...
public class FacadeInterfaceEntityPO extends AbstractFacadeEntityPO {
    ...
    public FacadeInterfaceEntityPO() {
    }

    public FacadeInterfaceEntityPO(Integer id, Integer isIntrusive, Integer isDecoupling, String name, Integer notAOSP, Integer oldAOSP, String ownership, String qualifiedName, Integer entityMapping, Integer commitsCount, String category, Integer calledTimes, String file, String packageName, String classBodyModify, String rawType, EnreLocationPO location, String modifiers) {
