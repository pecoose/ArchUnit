...
public class EnreTypeParameterEntityPO extends EnreInternalEntityPO {

    private String rawType;
    private String file;
    private EnreLocationPO location;

    public EnreTypeParameterEntityPO(Integer entityId, String entityName, String qualifiedName, String category, String ownership, Integer parentId, String rawType, String file, EnreLocationPO location) {
